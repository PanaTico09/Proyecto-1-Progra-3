...
//        l.mergeSortC(l.getCabeza());                                //Ordenamiento por mezcla 
//        l.pasaportePrimero();                                     //Si hay pasaportes los coloca en primera posicion.
        ...
        //Brick Sort
        b.addSimple("Nitzia", "Chi", "Yaslin", "7-0126-0769", 39.4); //Añade a la Lista
        b.addSimple("Johan", "Herrera", "Araya", "1-1711-0507", 19.1);
        b.addSimple("Mariana", "Castilla", "Arias", "M123785", 20.9);
        b.addSimple("Gimenha", "Sanchez", "Chi", "7-2750-0404", 17.5);
        b.addSimple("Daniela", "Zepeda", "Ramirez", "P985321", 20.9);
        b.addSimple("Karla", "Araya", "Chaves", "1-0929-0463", 41.5);
        b.addSimple("Rogel", "Herrera", "Bellido", "8-0083-0592", 45.5);
        b.addSimple("Angel", "Barrantes", "Chaves", "e770089", 18.7);
